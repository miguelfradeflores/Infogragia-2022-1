...
function scene:show( event )
    ...
    elseif ( phase == "did" ) then
        ...
        -- title:scale( 0.5, 0.5 )
        fondo= display.newImageRect(sceneGroup,"lose.png",cw,ch)
        fondo.x=0
        fondo.y=0
        fondo.anchorX=0
        fondo.anchorY=0
        squanchyf= display.newImageRect(sceneGroup,"sqf.png",500,500)
        squanchyf.x=50
        squanchyf.y=300
        squanchyf.anchorX=0
        squanchyf.anchorY=0
        startB = display.newImage(sceneGroup, "tryB.png", 100,730 )
        startB:scale( 0.5, 0.5 )
        startB.touch = jugar
        --startB.cantidad= 20
        startB:addEventListener( "touch", startB )
