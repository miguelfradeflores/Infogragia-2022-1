...
function scene:create(event)
	...
	background = display.newImageRect(sceneGroup, "images/mathias/space.jpg", display.contentWidth, display.contentHeight)
	...
	-- create overlay
	local overlay = display.newImageRect(sceneGroup, "images/mathias/pagebg1.png", display.contentWidth, display.contentHeight)
	overlay.anchorX = 0
	overlay.anchorY = 0
	overlay.x, overlay.y = 0, 0

	-- create sun, moon, and corona icon
	sunObj = display.newImageRect(sceneGroup, "images/mathias/sun.png", 300, 300)
	sunObj.x = display.contentWidth * 0.5
	sunObj.y = display.contentHeight * 0.5
	sunObj.isVisible = false

	moonObj = display.newImageRect(sceneGroup, "images/mathias/moon.png", 300, 300)
	moonObj.x = display.contentWidth * 0.5
	moonObj.y = display.contentHeight * 0.5
	moonObj.isVisible = false

	coronaIcon = display.newImageRect(sceneGroup, "images/mathias/coronaicon-big.png", 450, 444)
	coronaIcon.x = display.contentWidth * 0.5
