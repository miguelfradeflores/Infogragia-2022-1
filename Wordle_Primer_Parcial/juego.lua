...
set_de_palabras = {"ababa", "abaca", "abaco", "abada", "abadi", "abaja", "abaje", "abajo", "abala", "abale", "abalo", "abana", "abane", "abano", "abasi", "abata", "abate", "abati", "abato", "abece", "abeja", "abete", "abeto", "abiar", "abias", "abina", "abine", "avion",
...
"ebano", "ebria", "ebrio", "echad", "echan", "echar", "echas", "echen", "eches", "ecuas", "ecuos", "edema", "edila", "edita", "edite", "edito", "edrad", "edran", "edrar", "edras", "edren", "edres", "educa", "educe", "educi", "educo", "eduje", "edujo", "efebo", "efeta", "exito",
"fabas", "fabla", "fabos", "fabro", "facas", "facer", "faces", "facha", "fache", "facho", "facil", "facon", "facto", "fadas", "fados", "faena", "faene", "faeno", "fagos", "fagot", "faina", "faino", "fajad", "fajan", "fajar", "fajas", "fajea", "fajee", "fajen", "fajeo", "fajas", "finos",
"gaban", "gabar", "gacel", "gacha", "gache", "gachi", "gacho", "gafad", "gafan", "gafar", "gafas", "gafea", "gafee", "gafen", "gafeo", "gafes", "gafos", "gagas", "gagos", "gaita", "gajes", "gajos", "galan", "galas", "galce", "galea", "galeo", "gales", "galga", "galgo", "gallo", "gemir", "girar",
"habar", "habas", "haber", "habia", "habil", "habiz", "habla", "hable", "hablo", "habon", "habra", "habre", "habus", "hacan", "haced", "hacen", "hacer", "haces", "hacha", "hache", "hacho", "hacia", "hadar", "hadas", "hados", "hafiz", "hagan", "hagas", "halad", "huevo", 
...
"jabas", "jabis", "jable", "jabon", "jabra", "jabre", "jabri", "jabro", "jacal", "jacas", "jacer", "jacha", "jacos", "jacta", "jacte", "jacto", "jadas", "jadea", "jadee", "jadeo", "jades", "jadia", "jadie", "jadio", "jaece", "jaeza", "jaezo", "jagua", "jaiba", "jaima", "jarra",
"labeo", "labes", "labia", "labil", "labio", "labor", "labra", "labre", "labro", "lacad", "lacan", "lacar", "lacas", "lacea", "lacee", "lacen", "laceo", "laces", "lacha", "lacho", "lacia", "lacio", "lacon", "lacra", "lacre", "lacro", "lacta", "lacte", "lacto", "ladas", "lados", "ladra", "ladro",
"mabis", "mable", "macal", "macan", "macar", "macas", "macea", "macee", "macen", "maceo", "maces", "macha", "mache", "machi", "macho", "macia", "macio", "macis", "macla", "macon", "macro", "macua", "mador", "madre", "maesa", "maese", "maeso", "mafia", "metal", "meter", "meten", "matar", 
"nabab", "nabal", "nabar", "nabas", "nabis", "nabla", "nabos", "nacar", "nacas", "naced", "nacen", "nacer", "naces", "nacha", "nacho", "nacia", "nacio", "nacos", "nacre", "nadad", "nadal", "nadan", "nadar", "nadas", "naden", "nades", "nadga", "nadie", "nadir", "nafra", "negro", "negra", "nexos",
...
"pacae", "pacas", "pacay", "paced", "pacen", "pacer", "paces", "pacha", "pacho", "pacia", "pacio", "pacon", "pacos", "pacta", "pacte", "pacto", "pacus", "padre", "pafia", "pafio", "pagad", "pagan", "pagar", "pagas", "pagel", "pagos", "pagro", "pagua", "pague", "pahua", "parka",
...
"rabal", "rabas", "rabea", "rabee", "rabel", "rabeo", "rabia", "rabie", "rabil", "rabio", "rabis", "rabon", "rabos", "racea", "racee", "racel", "raceo", "racha", "rache", "racho", "racor", "racos", "radal", "radar", "radas", "rades", "radia", "radie", "radio", "radon", "ratas",
...
function crearBloqueLetraInput(posX,posY) -- bloque de letras (abajo)
    ...
    grupo_intermedio:insert(bloque)
end
...
function crearLetraBloque(posX, posY, palabra) -- letras del teclado de input (abajo)
    ...
    grupo_intermedio:insert(myText)
...
function crearLetra(posX, posY, letra) -- letra que va en bloque de palabras (arriba)
    ...
    grupo_intermedio:insert(myLetter)
...
function verificacionPalabra(palabra)
    ...
    if palabra == palabra_a_descubrir then
        ...
        ganar()
    elseif word_row_counter < 5 then
        --print("palabra:", palabra, "palabra_a_descubrir:",palabra_a_descubrir)
        print("palabra:", palabra, "palabra_a_descubrir:",palabra_a_descubrir)
        for i=0, #matrizCeldasLetras[word_row_counter] do
...
function scene:create( event )
	...
	-- FONDO
    fondo = display.newImageRect("/imagenes/snowdin.png", cw, ch)
